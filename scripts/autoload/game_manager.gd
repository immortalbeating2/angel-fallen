...
const DEFAULT_ACTIONS: Dictionary = {
	...
	"camp_hidden_fs1": [KEY_R],
	"camp_hidden_fs2": [KEY_Y],
	"camp_challenge_layer": [KEY_U],
	"camp_challenge_layer_2": [KEY_I],
	"camp_challenge_layer_3": [KEY_O],
	"camp_challenge_layer_4": [KEY_P],
...
const DEFAULT_JOYPAD_ACTIONS: Dictionary = {
	...
	"camp_hidden_fs1": [],
	"camp_hidden_fs2": [],
	"camp_challenge_layer": [],
	"camp_challenge_layer_2": [],
	"camp_challenge_layer_3": [],
	"camp_challenge_layer_4": [],
